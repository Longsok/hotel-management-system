...
<style>
    ...
    .filter-input { padding-left:34px; min-width:240px; }
    ...
    .customer-name  { font-size:13.5px; font-weight:600; color:#111827; }
    .customer-email { font-size:11.5px; color:#9ca3af; }
            ...
            <div class="filter-bar">
                <div class="filter-input-wrap">
                    ...
                    <input type="text" name="search" class="filter-input"
                           placeholder="Search name, email, phone, ID…" value="{{ request('search') }}">
                </div>
                ...
                @if(request()->hasAny(['search','status']))
                    <a href="{{ route('customers.index') }}" class="btn-reset">
    ...
    <div class="card-body p-0">
        ...
        <div style="padding:14px 20px; border-bottom:1px solid #f3f4f6; display:flex; align-items:center; justify-content:space-between;">
            <span style="font-size:13px; color:#6b7280;">
                Showing <strong style="color:#111827;">{{ $customers->firstItem() ?? 0 }}–{{ $customers->lastItem() ?? 0 }}</strong>
                of <strong style="color:#111827;">{{ $customers->total() }}</strong> customers
            </span>
        </div>
        ...
        @if($customers->isEmpty())
            <div class="empty-state">
                ...
                <p>No customers found. <a href="{{ route('customers.create') }}" style="color:#1a56db;">Add the first one.</a></p>
            </div>
        @else
            ...
            <table class="table table-hover mb-0" style="font-size:13.5px;">
                <thead style="background:#f9fafb;">
                    <tr>
                        ...
                        <th style="padding:11px 16px; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.5px; color:#9ca3af; border-bottom:1px solid #f3f4f6;">Phone</th>
                        <th style="padding:11px 16px; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.5px; color:#9ca3af; border-bottom:1px solid #f3f4f6;">Nationality</th>
                        <th style="padding:11px 16px; font-size:11px; font-weight:700; text-transform:uppercase; letter-spacing:.5px; color:#9ca3af; border-bottom:1px solid #f3f4f6;">Bookings</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding:12px 16px; vertical-align:middle;">
                            <span style="font-weight:600; color:#111827;">{{ $customer->bookings_count }}</span>
                        </td>
                        <td style="padding:12px 16px; vertical-align:middle;">
                        ...
                        <td style="padding:12px 16px; vertical-align:middle;">
                            <div style="display:flex; gap:5px;">
                                <a href="{{ route('customers.show', $customer) }}" class="action-btn" title="View">
